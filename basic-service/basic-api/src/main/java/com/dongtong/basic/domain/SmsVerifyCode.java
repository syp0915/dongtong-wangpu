...
/**
 * @Package: com.dongtong.basic.domain.SmsVerifyCode.java
 * @Description: 验证码表
 * @Company: 上海房产
 ...
 * version v1.0.0
 */
public class SmsVerifyCode extends BaseBean {
    /**
     * 验证码
     */
    ...
    /**
     * 使用场景0-登录 1-贷款申请 2-租铺签约 3-寻租申请 4-带我踩盘 5-商铺纠错 6-预约看铺
     */
    ...
    /**
     * 获取使用场景0-登录 1-贷款申请 2-租铺签约 3-寻租申请 4-带我踩盘 5-商铺纠错 6-预约看铺
     *
     * @return use_scene
     */
    ...
    /**
     * 设置使用场景0-登录 1-贷款申请 2-租铺签约 3-寻租申请 4-带我踩盘 5-商铺纠错 6-预约看铺
     *
     * @param useScene
     */
