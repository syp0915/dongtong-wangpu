...
/**
 * @Package: com.dongtong.clerk.domain.ClerkHistoryMonthRanking.java
 * @Description: 历史月排名
 * @Company: 上海房产
 ...
 * version v1.0.0
 */
public class ClerkHistoryMonthRanking extends BaseBean {
    /**
     * 用户ID
     */
    ...
    public String toString() {
        ...
        sb.append(", periodBeginTime=").append(periodBeginTime);
        sb.append(", periodEndTime=").append(periodEndTime);
