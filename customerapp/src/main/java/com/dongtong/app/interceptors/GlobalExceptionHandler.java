...
public class GlobalExceptionHandler {
    ...
    public ResultDO<String> jsonMappingException(JsonMappingException jsonMappingException) {
        return result(ErrorConstant.ERROR_FORMAT_PARMATER.getCode(), ErrorConstant.ERROR_FORMAT_PARMATER.getMsg(), jsonMappingException);
    }
    ...
    private void logException(Exception e){
        if(e instanceof  AppWebException){
            Logger.warn(GlobalExceptionHandler.class, e.getMessage(), e);
        }else{
            Logger.error(GlobalExceptionHandler.class, e.getMessage(), e);
        }
    }
}
